        ...
        <div>
          ...
          >
            ...
            <PopoverContent className="my-2 flex w-full flex-col items-center justify-center gap-2">
              <Label className="mb-2 font-black">{user && user.email}</Label>
              <Button
          ...
          >
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Are you susre you want to delete your acc. By deleting your
                  account you confirm that you'll lose access to it. After
                  deletion, there is no way to recover it back.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                ...
                <Button variant="destructive" onClick={handleDeleteUserAcc}>
                  Delete
                  {isLoading && <Spinner />}
                </Button>
              </DialogFooter>
